...
const TeachersFiltration = React.memo(({ subjects, filteringHandler, parametersItems, parametersHandler }) => {
		...
		<div className='teachers__filtration'>
			...
			<form className='form'>
				<fieldset className='form__fieldset'>
					...
					<select className='form__select' name='filtering' id='filterSubjects' onChange={setFilter}>
				...
				<fieldset className='form__fieldset'>
					...
					<select className='form__select' name='parameters' id='filterParameters' onChange={setParameter}>
